...
organization := "com.michaelhamrah"

version := "0.1.0-SNAPSHOT"

// description := "this project can foo a bar!"

homepage := Some(url("https://github.com/mhamrah/flickrgpx"))
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/mhamrah/flickrgpx"),
    "scm:git:https://github.com/mhamrah/flickrgpx.git",
    Some("scm:git:git@github.com:mhamrah/flickrgpx.git")
  )
)
...
/* entry point */
mainClass in (Compile, packageBin) := Some("com.michaelhamrah.flickrgpx.Main")

mainClass in (Compile, run) := Some("com.michaelhamrah.flickrgpx.Main")
...
/* assembly plugin */
mainClass in AssemblyKeys.assembly := Some("com.michaelhamrah.flickrgpx.Main")
